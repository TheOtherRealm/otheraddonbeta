...
tabs.on("ready", initiateContent);
var prefs = require('sdk/simple-prefs');
var browserPreferences = require("sdk/simple-storage");
var workers = require("sdk/content/worker");
var ui = require("sdk/ui");
var buttons = require('sdk/ui/button/action');
//set up a json object to hold all of the search buttons.  The iconURL's are embeded to make sure that they show up right away instead of having to be pulled from a remote server
var searchJSON = [
    {
	"id": "googleMapSearch",
	"label": "Google Maps",
	...
	"tabURL": "https://scholar.google.com/scholar?q="
    }, {
	"id": "imageSearch",
...
function initiateContent(tab) {
    tab.attach({
	contentScriptFile: [data.url("js/jquery-2.1.4.min.js"), data.url("js/jquery-ui.min.js")]
    });
}
...
var showHotKeyE = Hotkey({
    combo: prefs.prefs["extensionskeyWikiPedia"],
    onPress: function() {
		triggerWikiPedia();
    }
});
var showHotKeyD = Hotkey({
    combo: prefs.prefs["extensionskeyWikTionary"],
    onPress: function() {
		triggerWikTionary();
    }
});
var hideHotKey = Hotkey({
    combo: prefs.prefs["extensionskeyHide"],
    onPress: function() {
		triggerWikiClose();
    }
});
